...
from machineconfig.scripts.python.ai.solutions.gemini import INSTRUCTIONS_PATH_REFERENCE, SETTINGS_PATH_REFERENCE
...
def _build_gemini_instructions_text() -> str:
    ...
    gemini_instructions_path = get_path_reference_path(module=gemini_assets, path_reference=INSTRUCTIONS_PATH_REFERENCE)
...
def build_configuration(repo_root: Path, add_private_config: bool, add_instructions: bool) -> None:
    ...
    if add_private_config:
        ...
        settings_source_path = get_path_reference_path(module=gemini_assets, path_reference=SETTINGS_PATH_REFERENCE)

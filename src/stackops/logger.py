...
def get_logger(name: str | None = None) -> logging.Logger:
    ...
    Returns:
    - logging.Logger configured under the 'stackops' hierarchy.
    """
    if name is None:
        return _ROOT_LOGGER
...
# Convenience alias for simple imports: `from stackops.logger import logger`

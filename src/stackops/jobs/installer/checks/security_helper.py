...
if TYPE_CHECKING:
    ...
    from stackops.jobs.installer.checks.report_utils import AppData, AppMetadataRow, EngineReportRow, StoredEngineReportRow
...
def load_filtered_report_rows(
    ...
    from stackops.jobs.installer.checks.install_utils import load_app_metadata_report, load_engine_results_report
...
def build_report_options_text() -> str:
    from stackops.jobs.installer.checks.report_utils import APP_METADATA_KEYS, ENGINE_REPORT_KEYS

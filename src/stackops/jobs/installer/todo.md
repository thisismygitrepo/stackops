...
cd  ~/code/stackops/src/stackops fd -t f -E .venv -E docs -E tests -E '*.py'
...
# update toml files
cany ou ensure that my tv toml files are up to date? see if tv cli can dump new ones src/stackops/settings/television
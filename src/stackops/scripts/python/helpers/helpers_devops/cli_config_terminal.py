...
def get_app() -> typer.Typer:
    ...
    shell_app.command("windows-terminal-theme", no_args_is_help=False, help="<x> Select Windows Terminal color scheme.")(configure_windows_terminal_theme)
    ...
    shell_app.add_typer(cli_config_tmux.get_app(), name="tmux-style", help="<t> Style tmux through the Oh My Tmux framework.")

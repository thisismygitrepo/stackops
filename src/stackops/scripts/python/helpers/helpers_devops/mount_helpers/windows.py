...
from stackops.scripts.python.helpers.helpers_devops.mount_helpers.commands import ensure_ok, run_powershell
from stackops.scripts.python.helpers.helpers_devops.mount_helpers.device_entry import DeviceEntry
from stackops.scripts.python.helpers.helpers_devops.mount_helpers.utils import as_str, format_size_bytes
...
def list_windows_devices() -> list[DeviceEntry]:
    partitions_result = run_powershell("Get-Partition | Select-Object DiskNumber,PartitionNumber,DriveLetter,Size,Type,Guid | ConvertTo-Json")

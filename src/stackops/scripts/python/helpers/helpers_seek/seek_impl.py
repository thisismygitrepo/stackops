...
if TYPE_CHECKING:
    from stackops.scripts.python.helpers.helpers_search.ast_search import SymbolInfo
...
def _run_ast_search(path: str) -> None:
    """Run AST search."""
    from stackops.scripts.python.helpers.helpers_search.ast_search import get_repo_symbols
    from stackops.utils.options_utils.tv_options import choose_from_dict_with_preview
...
def _run_text_search(rga: bool, directory: str | None, search_term: str) -> None:
    ...
    import stackops.scripts.python.helpers.helpers_seek.scripts_linux as linux_scripts
    import stackops.scripts.python.helpers.helpers_seek.scripts_macos as macos_scripts
    import stackops.scripts.python.helpers.helpers_seek.scripts_windows as windows_scripts

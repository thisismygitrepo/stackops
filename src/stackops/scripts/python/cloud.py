...
def copy(
    ...
    overwrite: Annotated[bool, typer.Option("--overwrite/--no-overwrite", "-o/-N", help="📝 Overwrite existing file.")] = defaults["overwrite"],
...
def get_app() -> typer.Typer:
    ...
    app = typer.Typer(
        add_completion=False, no_args_is_help=True, help="☁ Cloud management commands",

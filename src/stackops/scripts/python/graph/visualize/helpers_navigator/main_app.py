"""
Main TUI application for navigating stackops commands.
"""
...
from stackops.scripts.python.graph.visualize.helpers_navigator.command_builder import CommandBuilderScreen
from stackops.scripts.python.graph.visualize.helpers_navigator.command_detail import CommandDetail
from stackops.scripts.python.graph.visualize.helpers_navigator.command_tree import CommandTree
from stackops.scripts.python.graph.visualize.helpers_navigator.data_models import CommandInfo
...
class CommandNavigatorApp(App[None]):
    """TUI application for navigating stackops commands."""
    ...
    def compose(self) -> ComposeResult:
        ...
        yield CommandTree("📚 stackops Commands", id="command-tree")
        yield CommandDetail(id="command-detail")
        yield Footer()

    def on_mount(self) -> None:
        """Actions when app is mounted."""
        self.title = "stackops Command Navigator"

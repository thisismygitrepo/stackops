...
function devops   { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.8" devops $args }
function cloud    { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.8" cloud $args }
function agents   { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.8" agents $args }
function sessions { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.8" sessions $args }
function fire     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.8" fire $args }
function preview { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.8" preview $args }
function utils    { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.8" utils $args }
function terminal { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.8" terminal $args }
function seek     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.8" seek @args }

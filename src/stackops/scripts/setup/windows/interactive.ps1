...
function devops   { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.104" devops $args }
function cloud    { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.104" cloud $args }
function agents   { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.104" agents $args }
function sessions { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.104" sessions $args }
function fire     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.104" fire $args }
function preview { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.104" preview $args }
function utils    { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.104" utils $args }
function terminal { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.104" terminal $args }
function seek     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.104" seek @args }

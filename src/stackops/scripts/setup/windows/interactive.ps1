...
function devops   { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.6" devops $args }
function cloud    { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.6" cloud $args }
function agents   { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.6" agents $args }
function sessions { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.6" sessions $args }
function fire     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.6" fire $args }
function preview { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.6" preview $args }
function utils    { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.6" utils $args }
function terminal { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.6" terminal $args }
function seek     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.6" seek @args }

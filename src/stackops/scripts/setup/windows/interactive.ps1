...
function devops   { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.7" devops $args }
function cloud    { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.7" cloud $args }
function agents   { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.7" agents $args }
function sessions { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.7" sessions $args }
function fire     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.7" fire $args }
function preview { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.7" preview $args }
function utils    { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.7" utils $args }
function terminal { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.7" terminal $args }
function seek     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.7" seek @args }

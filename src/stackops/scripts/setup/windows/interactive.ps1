...
function devops   { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.98" devops $args }
function cloud    { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.98" cloud $args }
function agents   { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.98" agents $args }
function sessions { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.98" sessions $args }
function fire     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.98" fire $args }
function croshell { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.98" croshell $args }
function utils    { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.98" utils $args }
function terminal { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.98" terminal $args }
function seek     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=8.98" seek @args }

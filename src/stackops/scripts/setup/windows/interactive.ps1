...
function terminal { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.9" terminal $args }
function seek     { & "$HOME\.local\bin\uvx.exe" --python 3.14 --from "stackops>=26.9" seek @args }

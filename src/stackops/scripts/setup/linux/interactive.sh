...
alias devops='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.104" devops'
alias cloud='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.104" cloud'
alias agents='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.104" agents'
alias fire='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.104" fire'
alias preview='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.104" preview'
alias utils='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.104" utils'
alias terminal='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.104" terminal'
seek() { "$HOME/.local/bin/uvx" --python 3.14 --from "stackops>=8.104" seek "$@"; }

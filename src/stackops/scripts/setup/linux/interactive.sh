...
alias devops='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.5" devops'
alias cloud='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.5" cloud'
alias agents='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.5" agents'
alias fire='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.5" fire'
alias preview='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.5" preview'
alias utils='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.5" utils'
alias terminal='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.5" terminal'
seek() { "$HOME/.local/bin/uvx" --python 3.14 --from "stackops>=26.6.5" seek "$@"; }

...
alias devops='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.8" devops'
alias cloud='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.8" cloud'
alias agents='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.8" agents'
alias fire='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.8" fire'
alias preview='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.8" preview'
alias utils='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.8" utils'
alias terminal='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.8" terminal'
seek() { "$HOME/.local/bin/uvx" --python 3.14 --from "stackops>=26.8" seek "$@"; }

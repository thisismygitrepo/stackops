...
alias devops='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.100" devops'
alias cloud='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.100" cloud'
alias agents='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.100" agents'
alias fire='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.100" fire'
alias croshell='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.100" croshell'
alias utils='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.100" utils'
alias terminal='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=8.100" terminal'
seek() { "$HOME/.local/bin/uvx" --python 3.14 --from "stackops>=8.100" seek "$@"; }

...
alias devops='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.6" devops'
alias cloud='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.6" cloud'
alias agents='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.6" agents'
alias fire='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.6" fire'
alias preview='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.6" preview'
alias utils='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.6" utils'
alias terminal='$HOME/.local/bin/uvx --python 3.14 --from "stackops>=26.6.6" terminal'
seek() { "$HOME/.local/bin/uvx" --python 3.14 --from "stackops>=26.6.6" seek "$@"; }

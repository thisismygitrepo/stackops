...
commands_module = importlib.import_module("stackops.scripts.python.agents_parallel_commands")
...
def test_agents_create_passes_decoded_separator(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    fake_agents_impl = types.ModuleType("stackops.scripts.python.helpers.helpers_agents.agents_impl")
    ...
    monkeypatch.setitem(
        sys.modules,
        "stackops.scripts.python.helpers.helpers_agents.agents_impl",
        fake_agents_impl,
    )
...
def test_create_context_appends_instruction_and_writes_separator_file(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    captured: dict[str, object] = {}
    fake_run_impl_module = types.ModuleType("stackops.scripts.python.helpers.helpers_agents.agents_run_impl")
    ...
    monkeypatch.setitem(
        sys.modules,
        "stackops.scripts.python.helpers.helpers_agents.agents_run_impl",

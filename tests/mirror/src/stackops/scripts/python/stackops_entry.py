...
def test_fire_forwards_runtime_options(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    _install_module(monkeypatch, "stackops.scripts.python.fire_jobs", {"fire": fake_fire})
...
def test_croshell_maps_backend_and_forwards_args(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    _install_module(monkeypatch, "stackops.scripts.python.croshell", {"croshell": fake_croshell})
...
@pytest.mark.parametrize(
    ...
    [
        ("devops", "stackops.scripts.python.devops"),
        ("cloud", "stackops.scripts.python.cloud"),
        ("terminal", "stackops.scripts.python.terminal"),
        ("agents", "stackops.scripts.python.agents"),
        ("utils", "stackops.scripts.python.utils"),
        ("seek", "stackops.scripts.python.seek"),
    ],
)

...
import stackops.utils as stackops_utils_package
import pytest
import typer
from typer.testing import CliRunner

import stackops.scripts.python.devops as devops_module
...
@pytest.mark.parametrize(
    ...
    [
        (
            "repos",
            "stackops.scripts.python.helpers.helpers_devops.cli_repos",
        ),
        (
            "config",
            "stackops.scripts.python.helpers.helpers_devops.cli_config",
        ),
        (
            "data",
            "stackops.scripts.python.helpers.helpers_devops.cli_data",
        ),
        (
            "self_cmd",
            "stackops.scripts.python.helpers.helpers_devops.cli_self",
        ),
        (
            "network",
            "stackops.scripts.python.helpers.helpers_devops.cli_nw",
        ),
    ],
)
...
def test_execute_lazy_loads_script_runner_and_forwards_arguments(
    ...
    _register_callable_module(
        monkeypatch,
        "stackops.scripts.python.helpers.helpers_devops.run_script",
        "run_py_script",
        calls,
    )

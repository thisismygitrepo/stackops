...
from stackops.scripts.python.helpers.helpers_agents.agent_impl_interactive import create_options as create_options_module
from stackops.scripts.python.helpers.helpers_agents.agent_impl_interactive import main as main_module
...
def test_main_forwards_collected_args_to_agents_create(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    fake_agents_module = ModuleType("stackops.scripts.python.helpers.helpers_agents.agents_impl")
    ...
    monkeypatch.setitem(sys.modules, "stackops.scripts.python.helpers.helpers_agents.agents_impl", fake_agents_module)

...
from stackops.scripts.python.helpers.helpers_utils import machine_utils_app as subject
...
def test_wrappers_and_mount_device_delegate_to_underlying_modules(
    ...
    call_log: list[str] = []
    procs_module = ModuleType("stackops.utils.procs")
    python_module = ModuleType("stackops.scripts.python.helpers.helpers_utils.python")
    cli_config_mount_module = ModuleType("stackops.scripts.python.helpers.helpers_devops.cli_config_mount")
    helpers_devops_module = ModuleType("stackops.scripts.python.helpers.helpers_devops")
    ...
    install_module(monkeypatch, "stackops.utils.procs", procs_module)
    install_module(
        monkeypatch,
    ...
    install_module(
        monkeypatch,
        "stackops.scripts.python.helpers.helpers_devops.cli_config_mount",
        cli_config_mount_module,
    )
    install_module(
        monkeypatch,
        "stackops.scripts.python.helpers.helpers_devops",

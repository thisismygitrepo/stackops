...
from stackops.scripts.python.helpers.helpers_utils import file_utils_app as subject
...
def test_wrapper_functions_delegate_to_underlying_modules(
    ...
    call_log: list[str] = []
    python_module = ModuleType("stackops.scripts.python.helpers.helpers_utils.python")
    download_module = ModuleType("stackops.scripts.python.helpers.helpers_utils.download")
    pdf_module = ModuleType("stackops.scripts.python.helpers.helpers_utils.pdf")
    read_db_module = ModuleType("stackops.scripts.python.helpers.helpers_utils.read_db_cli_tui")
    ...
    install_module(
        monkeypatch,
        "stackops.scripts.python.helpers.helpers_utils.python",
        python_module,
    )
    install_module(
        monkeypatch,
        "stackops.scripts.python.helpers.helpers_utils.download",
        download_module,
    )
    install_module(
        monkeypatch,
        "stackops.scripts.python.helpers.helpers_utils.pdf",
        pdf_module,
    )
    install_module(
        monkeypatch,
        "stackops.scripts.python.helpers.helpers_utils.read_db_cli_tui",
        read_db_module,
    )

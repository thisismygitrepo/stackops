...
from stackops.scripts.python.helpers.helpers_network.ssh import ssh_debug_linux as target
...
def test_ssh_debug_linux_delegates_to_darwin(monkeypatch: pytest.MonkeyPatch) -> None:
    module_name = "stackops.scripts.python.helpers.helpers_network.ssh.ssh_debug_darwin"

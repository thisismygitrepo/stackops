...
from stackops.scripts.python.helpers.helpers_devops import cli_share_server as module
...
def install_web_file_explorer_stubs(monkeypatch: pytest.MonkeyPatch, lan_ip: str | None, recorded_scripts: list[str]) -> list[str]:
    ...
    installer_module = ModuleType("stackops.utils.installer_utils.installer_cli")
    ...
    monkeypatch.setitem(sys.modules, "stackops.utils.installer_utils.installer_cli", installer_module)

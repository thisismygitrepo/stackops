...
from stackops.scripts.python.helpers.helpers_devops import cli_self_docs as module
...
def test_write_cli_graph_snapshot_writes_json_payload(monkeypatch: pytest.MonkeyPatch, tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
    generated_module = ModuleType("stackops.scripts.python.graph.generate_cli_graph")
    ...
    monkeypatch.setitem(sys.modules, "stackops.scripts.python.graph.generate_cli_graph", generated_module)
...
def test_render_docs_artifact_creates_parent_and_calls_plotly(
    ...
    plotly_views_module = ModuleType("stackops.scripts.python.graph.visualize.plotly_views")
    ...
    monkeypatch.setitem(sys.modules, "stackops.scripts.python.graph.visualize.plotly_views", plotly_views_module)

...
from stackops.scripts.python.helpers.helpers_sessions import sessions_layout_source as subject
...
def test_resolve_layouts_file_path_missing_shows_help_and_exits(
    ...
    assert f"Layouts file not found: {tmp_path / 'dotfiles' / 'stackops' / 'layouts.json'}" in captured.err

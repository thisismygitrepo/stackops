...
from stackops.scripts.python.helpers.helpers_sessions import utils as subject
...
def test_balance_load_writes_adjusted_layout_file(
    ...
    calls: list[str] = []
    load_balancer_module = ModuleType("stackops.cluster.sessions_managers.utils.load_balancer")

...
import stackops.scripts.python.helpers.helpers_sessions.sessions_cli_run_all as subject
...
def test_run_all_cli_merges_tabs_and_calls_dynamic_runner(
    ...
    module = ModuleType(
        "stackops.scripts.python.helpers.helpers_sessions.sessions_dynamic"
    )

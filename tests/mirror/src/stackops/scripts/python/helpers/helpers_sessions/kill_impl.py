...
import stackops.scripts.python.helpers.helpers_sessions.kill_impl as subject


@pytest.mark.parametrize(
    ("backend", "module_name"),
    [
        ("zellij", "stackops.scripts.python.helpers.helpers_sessions._zellij_backend"),
        ("tmux", "stackops.scripts.python.helpers.helpers_sessions._tmux_backend"),
    ],
)

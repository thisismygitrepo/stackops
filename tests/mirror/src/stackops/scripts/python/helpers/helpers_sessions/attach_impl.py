...
import stackops.scripts.python.helpers.helpers_sessions.attach_impl as subject
...
def test_interactive_choose_with_preview_uses_tv_preview(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    module = ModuleType("stackops.utils.options_utils.tv_options")
...
def test_choose_session_dispatches_to_requested_backend(monkeypatch: pytest.MonkeyPatch) -> None:
    zellij_module = ModuleType("stackops.scripts.python.helpers.helpers_sessions._zellij_backend")
    tmux_module = ModuleType("stackops.scripts.python.helpers.helpers_sessions._tmux_backend")

...
from stackops.scripts.python.helpers.helpers_sessions import sessions_impl as subject
...
def test_select_layout_strips_comments_and_matches_case_insensitively(
    ...
    install_module(monkeypatch, "stackops.utils.io", io_module)
...
def test_run_layouts_windows_terminal_batches_and_restarts(
    ...
    wt_module = ModuleType("stackops.cluster.sessions_managers.windows_terminal.wt_local_manager")

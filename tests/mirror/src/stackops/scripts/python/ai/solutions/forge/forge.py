...
from stackops.scripts.python.ai.solutions.forge.forge import FORGE_SCHEMA_URL, build_configuration
from stackops.scripts.python.ai.utils.shared import get_generic_instructions_path


FORGE_MODULE = importlib.import_module("stackops.scripts.python.ai.solutions.forge.forge")

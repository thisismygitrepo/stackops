...
def test_get_os_name_maps_supported_platform_values(
...
def test_get_os_name_rejects_unknown_platform(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_get_normalized_arch_maps_common_machine_names(
    monkeypatch: pytest.MonkeyPatch,
    machine_name: str,
    expected: str,
) -> None:

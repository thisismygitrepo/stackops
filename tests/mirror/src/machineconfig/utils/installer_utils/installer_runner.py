...
from machineconfig.utils.installer_utils import installer_runner as runner
...
def test_get_machineconfig_version_falls_back_to_pyproject(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    ...
    assert runner.get_machineconfig_version() == "9.9.9"

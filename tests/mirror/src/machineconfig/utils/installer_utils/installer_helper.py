...
import machineconfig.utils.installer_utils.installer_helper as installer_helper
...
def test_download_and_prepare_decompresses_nested_archive(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr("machineconfig.scripts.python.helpers.helpers_utils.download.download", fake_download)

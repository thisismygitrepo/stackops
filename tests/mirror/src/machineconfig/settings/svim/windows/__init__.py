...
from machineconfig.settings.svim import windows
...
def test_init_path_reference_points_to_existing_local_file() -> None:
    module_dir = Path(windows.__file__).resolve().parent
    _assert_local_reference(module_dir, windows.INIT_PATH_REFERENCE)

...
from machineconfig.settings.svim import linux
...
def test_init_path_reference_points_to_existing_local_file() -> None:
    module_dir = Path(linux.__file__).resolve().parent
    _assert_local_reference(module_dir, linux.INIT_PATH_REFERENCE)

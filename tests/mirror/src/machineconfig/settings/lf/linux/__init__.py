...
import machineconfig.settings.lf.linux as subject
...
def test_path_references_resolve_to_existing_resources() -> None:
    ...
    missing_references = tuple(
        reference
        for reference in (subject.COLORS_PATH_REFERENCE, subject.ICONS_PATH_REFERENCE, subject.LFRC_PATH_REFERENCE)

...
from machineconfig.scripts.python import seek as module
...
def test_seek_delegates_all_runtime_flags(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    _install_module(monkeypatch, "machineconfig.scripts.python.helpers.helpers_seek.seek_impl", {"seek": fake_seek})

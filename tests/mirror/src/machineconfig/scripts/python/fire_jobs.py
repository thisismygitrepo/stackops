...
def _install_fire_job_modules(
    ...
    *,
    ...
    args_module = ModuleType(
        "machineconfig.scripts.python.helpers.helpers_fire_command.fire_jobs_args_helper"
    )
    impl_module = ModuleType(
        "machineconfig.scripts.python.helpers.helpers_fire_command.fire_jobs_impl"
    )

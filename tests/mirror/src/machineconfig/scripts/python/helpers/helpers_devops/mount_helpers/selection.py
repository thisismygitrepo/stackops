...
from machineconfig.scripts.python.helpers.helpers_devops.mount_helpers import selection as module_under_test
...
def install_options_module(monkeypatch: pytest.MonkeyPatch, chooser: object) -> None:
    stub = ModuleType("machineconfig.utils.options")
    setattr(stub, "choose_from_options", chooser)
    monkeypatch.setitem(sys.modules, "machineconfig.utils.options", stub)

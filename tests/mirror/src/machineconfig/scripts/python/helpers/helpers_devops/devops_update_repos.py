...
from machineconfig.scripts.python.helpers.helpers_devops import devops_update_repos as module_under_test
from machineconfig.scripts.python.helpers.helpers_repos.update import RepositoryUpdateResult

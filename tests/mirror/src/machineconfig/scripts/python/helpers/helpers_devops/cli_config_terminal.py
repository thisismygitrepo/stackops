...
import machineconfig.profile.create_shell_profile as create_shell_profile_module
import machineconfig.scripts.python.helpers.helpers_devops.cli_config_terminal as cli_config_terminal_module

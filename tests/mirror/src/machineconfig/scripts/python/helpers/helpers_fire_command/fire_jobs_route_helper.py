...
import machineconfig.scripts.python.helpers.helpers_fire_command.fire_jobs_route_helper as subject

_PARSE_MODULE = "machineconfig.scripts.python.helpers.helpers_fire_command.file_wrangler"

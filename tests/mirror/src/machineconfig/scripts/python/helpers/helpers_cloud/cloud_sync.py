...
from machineconfig.scripts.python.helpers.helpers_cloud import cloud_sync
...
def _install_parse_module(monkeypatch: pytest.MonkeyPatch, *, cloud: str, resolved_source: str, resolved_target: str) -> None:
    ...
    monkeypatch.setitem(sys.modules, "machineconfig.scripts.python.helpers.helpers_cloud.helpers2", module)
...
def test_main_runs_plain_rclone_sync_when_verbose_is_false(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setitem(sys.modules, "machineconfig.scripts.python.helpers.helpers_cloud.cloud_mount", cloud_mount_module)

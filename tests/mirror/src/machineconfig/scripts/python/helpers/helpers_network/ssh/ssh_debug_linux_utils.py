...
def test_detect_package_manager_prefers_apt(monkeypatch: object) -> None:
...
def test_detect_package_manager_returns_unknown_when_none_found(monkeypatch: object) -> None:
    class FakePath:
        def __init__(self, value: str) -> None:
            self.value = value

...
import machineconfig.scripts.python.helpers.helpers_network.ssh as subject
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Linux",
            "machineconfig.scripts.python.helpers.helpers_network.ssh.ssh_debug_linux",
            "ssh_debug_linux",
            {"linux": {"ok": True}},
        ),
        (
            "Darwin",
            "machineconfig.scripts.python.helpers.helpers_network.ssh.ssh_debug_darwin",
            "ssh_debug_darwin",
            {"darwin": {"ok": True}},
        ),
        (
            "Windows",
            "machineconfig.scripts.python.helpers.helpers_network.ssh.ssh_debug_windows",
            "ssh_debug_windows",
            {"windows": {"ok": True}},
        ),
    ],

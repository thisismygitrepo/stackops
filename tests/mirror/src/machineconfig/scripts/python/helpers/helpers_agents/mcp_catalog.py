...
from machineconfig.scripts.python.helpers.helpers_agents import mcp_catalog as module
from machineconfig.scripts.python.helpers.helpers_agents.mcp_types import McpCatalogLocation

...
def test_chatgpt_package_import_exposes_expected_package_directory() -> None:
    package = importlib.import_module(
        "machineconfig.scripts.python.helpers.helpers_agents.privacy.configs.chatgpt"
    )
    privacy_module = importlib.import_module(
        "machineconfig.scripts.python.helpers.helpers_agents.privacy.configs.chatgpt.chatgpt_privacy"
    )

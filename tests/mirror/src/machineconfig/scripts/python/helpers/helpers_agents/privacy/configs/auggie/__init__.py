...
def test_auggie_package_import_exposes_expected_package_directory() -> None:
    package = importlib.import_module(
        "machineconfig.scripts.python.helpers.helpers_agents.privacy.configs.auggie"
    )
    privacy_module = importlib.import_module(
        "machineconfig.scripts.python.helpers.helpers_agents.privacy.configs.auggie.auggie_privacy"
    )

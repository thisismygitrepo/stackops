...
import machineconfig.utils.meta as meta_utils
from machineconfig.scripts.python.helpers.helpers_croshell import croshell_impl
...
def test_build_preprogram_contains_bootstrap_and_fallback_message() -> None:
    ...
    assert 'print_logo("Machineconfig")' in preprogram
    assert "Croshell: machineconfig is not installed in the current environment." in preprogram

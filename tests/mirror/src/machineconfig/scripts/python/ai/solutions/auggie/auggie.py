...
from machineconfig.scripts.python.ai.solutions.auggie import auggie as auggie_module
...
def test_build_configuration_skips_output_when_instructions_disabled(tmp_path: Path) -> None:
    ...
    auggie_module.build_configuration(
        repo_root=repo_root,
...
def test_build_configuration_writes_guidelines_from_instruction_file(
    tmp_path: Path,

...
from machineconfig.scripts.python.ai.solutions.opencode import opencode as opencode_module
...
def test_build_configuration_writes_missing_opencode_files(tmp_path: Path) -> None:
    ...
    opencode_module.build_configuration(
        repo_root=repo_root,
    ...
    config_source = get_path_reference_path(

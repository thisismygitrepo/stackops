...
from machineconfig.scripts.python.graph.visualize.helpers_navigator.main_app import (
    CommandNavigatorApp,
)
...
def test_execute_command_reports_success_error_and_timeout(monkeypatch: MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "machineconfig.scripts.python.graph.visualize.helpers_navigator.main_app.subprocess.run",
        run_success,
    )

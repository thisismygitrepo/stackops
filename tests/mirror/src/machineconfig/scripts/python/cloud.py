...
import machineconfig.scripts.python.cloud as cloud_module
...
def test_sync_lazy_loads_helper_and_forwards_arguments(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    _register_callable_module(monkeypatch, "machineconfig.scripts.python.helpers.helpers_cloud.cloud_sync", "main", calls)
...
def test_copy_lazy_loads_helper_and_forwards_arguments(monkeypatch: pytest.MonkeyPatch) -> None:
    calls: list[Invocation] = []
    _register_callable_module(monkeypatch, "machineconfig.scripts.python.helpers.helpers_cloud.cloud_copy", "main", calls)
...
def test_mount_lazy_loads_helper_and_forwards_arguments(monkeypatch: pytest.MonkeyPatch) -> None:
    calls: list[Invocation] = []
    _register_callable_module(monkeypatch, "machineconfig.scripts.python.helpers.helpers_cloud.cloud_mount", "mount", calls)
...
def test_ftpx_lazy_loads_helper_and_forwards_arguments(monkeypatch: pytest.MonkeyPatch) -> None:
    calls: list[Invocation] = []
    _register_callable_module(monkeypatch, "machineconfig.scripts.python.ftpx", "ftpx", calls)

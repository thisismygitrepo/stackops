...
4. If command names change, regenerate the graph with `UV_CACHE_DIR=/tmp/uv-cache uv run python -m stackops.scripts.python.graph.generate_cli_graph`, then refresh these references.

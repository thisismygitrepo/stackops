...
| `stackops.scripts.python.helpers.helpers_devops.cli_self_ai.agentops_yaml` | `cli-helper` | `cli-helper` | `medium` | __main__, funcs:12 | src/stackops/scripts/python/helpers/helpers_devops/cli_self_ai/agentops_yaml.py |  |
...
| `stackops.scripts.python.helpers.helpers_devops.cli_self_ai.agentops_yaml` | `cli-helper` | `cli-helper` | `medium` | 0 | 166 | __main__, funcs:12 | src/stackops/scripts/python/helpers/helpers_devops/cli_self_ai/agentops_yaml.py |  |

...
| `stackops.scripts.python.helpers.helpers_devops.cli_self_ai.agent_ops_yaml` | `cli-helper` | `cli-helper` | `medium` | __main__, funcs:12 | src/stackops/scripts/python/helpers/helpers_devops/cli_self_ai/agent_ops_yaml.py |  |
...
| `stackops.scripts.python.helpers.helpers_devops.cli_self_ai.agent_ops_yaml` | `cli-helper` | `cli-helper` | `medium` | 0 | 166 | __main__, funcs:12 | src/stackops/scripts/python/helpers/helpers_devops/cli_self_ai/agent_ops_yaml.py |  |
...
| `stackops.scripts.python.helpers.helpers_sessions.sessions_aoe_impl` | `cli-helper` | `cli-helper` | `medium` | 1 | 278 | classes:2, funcs:12 | src/stackops/scripts/python/helpers/helpers_sessions/sessions_aoe_impl.py |  |
| `stackops.scripts.python.helpers.helpers_sessions.sessions_cli_common` | `cli` | `cli-module` | `high` | 2 | 186 | typer, funcs:6 | src/stackops/scripts/python/helpers/helpers_sessions/sessions_cli_common.py |  |
| `stackops.scripts.python.helpers.helpers_sessions.sessions_cli_run` | `cli` | `cli-module` | `high` | 1 | 129 | typer, funcs:1 | src/stackops/scripts/python/helpers/helpers_sessions/sessions_cli_run.py |  |
